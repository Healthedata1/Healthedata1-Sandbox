...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'tribalAffiliation']) &gt;= 1">extension with URL = 'tribalAffiliation': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'tribalAffiliation']) &lt;= 1">extension with URL = 'tribalAffiliation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'isEnrolled']) &lt;= 1">extension with URL = 'isEnrolled': maximum cardinality of 'extension' is 1</sch:assert>
