...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/5.0.0/StructureDefinition/extension-DiagnosticReport.media']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/5.0.0/StructureDefinition/extension-DiagnosticReport.media': maximum cardinality of 'extension' is 1</sch:assert>
