...
use <a href="http://hl7.org/fhir/R4/datatypes.html#url">url</a> to get the title an link for :
...
what about terminology?:   e.g., '{% raw %} <a href="ValueSet-us-core-source-of-payment.html">US Core Source of Payment Value Set</a> {% endraw %}' = <a href="ValueSet-us-core-source-of-payment.html">US Core Source of Payment Value Set</a>
